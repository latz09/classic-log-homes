...
// Renders one row of the "Submission Details" box.
// This is the same field-type switch your old formatFieldValue() had —
// same behavior, just JSX instead of a template-literal string.
export function FieldRow({ field, value, colors, isLast = false, compact = false }) {
