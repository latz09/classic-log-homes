...
const ColorPalette = () => {
	...
	const brandColors = [
		{ name: 'Black', var: 'black' },
		{ name: 'Dark Gold', var: 'darkGold' },
		{ name: 'Gold', var: 'gold' },
	...
	return (
		<div className='max-w-5xl mx-auto px-2 py-4 border border-darkGold rounded bg-[#000000] shadow-card'>
			<h2 className='mb-2'>Color Palette</h2>
			<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1.5'>
				{brandColors.map((color) => (
					<div
						key={color.var}
						className='group border border-darkGold rounded overflow-hidden'
					>
						<div
						...
						<div className='p-1 space-y-0.25 group-hover:hidden'>
							...
							<p className='text-[0.875rem] text-dark/60 uppercase'>
								{colors[color.var]}
							</p>
